...
### Added
- New `--safe-mode` global flag: Start with all customizations (CLAUDE.md, skills, plugins, hooks, MCP servers, etc.) disabled — useful for troubleshooting. Sets `CLAUDE_CODE_SAFE_MODE=1`
